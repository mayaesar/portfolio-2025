...
export default function Header() {
    ...
    return (
        <section
            ...
            style={{
                background: "linear-gradient(to bottom, var(--tw-gradient-from) 0%, var(--tw-gradient-via-position) 90%, var(--tw-gradient-to) 100%)"
            }}
        >
            <div className="w-full max-w-screen-lg flex items-center justify-between mx-auto px-4">
                <div className="flex gap-4">
                    <Link href="https://www.linkedin.com/in/mayaesar/" target="_blank"
                          className="text-2xl text-gray-700 dark:text-gray-300 hover:text-gray-900 hover:dark:text-gray-100">
                        <FaLinkedin/>
                    </Link>
                    <Link href="https://github.com/mayaesar" target="_blank"
                          className="text-2xl text-gray-700 dark:text-gray-300 hover:text-gray-900 hover:dark:text-gray-100">
                        <FaGithub/>
                    </Link>
                    <Link href="https://www.tiktok.com/@mayaesar" target="_blank"
                          className="text-2xl text-gray-700 dark:text-gray-300 hover:text-gray-900 hover:dark:text-gray-100">
                        <FaTiktok/>
                    </Link>
                    <Link href="mailto:mayaesar@gmail.com" className="text-2xl text-gray-700 dark:text-gray-300 hover:text-gray-900 hover:dark:text-gray-100">
                        <FaEnvelope/>
                    </Link>
                </div>
                <div>
